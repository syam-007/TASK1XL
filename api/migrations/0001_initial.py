    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "permissions": [("cancel_job", "can cancel job")],
            },
        ),
        migrations.CreateModel(
            name="JobInfo",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("Measured_Depth", models.DecimalField(decimal_places=2, max_digits=3)),
                ("Inclination", models.DecimalField(decimal_places=2, max_digits=3)),
                ("Azimuth", models.DecimalField(decimal_places=2, max_digits=3)),
                (
                    "job_number",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="api.createjob"
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("latitude_3", models.DecimalField(decimal_places=2, max_digits=4)),
                ("longitude_1", models.IntegerField()),
                ("longitude_2", models.IntegerField()),
                ("longitude_3", models.DecimalField(decimal_places=2, max_digits=4)),
                ...
                ("GLE", models.DecimalField(decimal_places=2, max_digits=3)),
